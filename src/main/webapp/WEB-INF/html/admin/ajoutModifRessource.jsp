...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}${modifier ? '/admin/ressource/modifier' : '/admin/ressource/ajouter'}" method="post"
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <input id="description" name="descriptionRessource" type="text" value="${ressource.description}"
                       class="form-control"
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <input id="localisation" name="localisationRessource" type="text" value="${ressource.localisation}"
                       class="form-control"
        ...
        <div class="form-group">
            ...
            <div class="col-md-2">
                <button type="submit" class="btn btn-default">${modifier ? 'Modifier' : 'Ajouter'} une ressource
                </button>
            </div>
        </div>
    </form>
