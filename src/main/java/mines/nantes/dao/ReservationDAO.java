...
public class ReservationDAO extends AbstractDAO<Reservation> {
    ...
    /**
     * Retourne la liste des reservations d'une ressource a partir d'une date
     * @param ressource
     * @param dateDebut
     * @return
     */
    ...
    /**
     * Retourne la totalite des reservations
     * @return
     */
    ...
    /**
     * Retourne la liste des reservations pour une periode donnee
     * @param dateDebut
     * @param dateFin
     * @return
     */
